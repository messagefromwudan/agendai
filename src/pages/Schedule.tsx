                  ...
                  {dayClasses.map((classEvent) => {
                    ...
                    return (
                      <div
                        ...
                        className={`${isToday ? 'bg-white/10 border-white/20' : `${colorClasses.light} border ${colorClasses.border}`} border rounded-lg p-2 transition-all hover:scale-105 hover:z-50 relative cursor-pointer hover:shadow-lg`}
                      >
