...
type Mode = "loading" | "recovery" | "success";
...
export default function AuthCallback() {
  ...
  if (mode === "success") {
    return (
      <>
        ...
        <div className={`${inter.variable} ${poppins.variable} font-sans min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4`}>
  ...
  return (
    <>
      <Head><title>Parolă nouă — AgendAI</title></Head>
      <div className={`${inter.variable} ${poppins.variable} font-sans min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4`}>
